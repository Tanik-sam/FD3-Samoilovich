...
interface IScalable {
  getScale(_name:string,_color:string, _taste:'sour'|'sweet'|'plain',_weight:number):number;
  getName(_name:string,_color:string, _taste:'sour'|'sweet'|'plain',_weight:number):string;
}
